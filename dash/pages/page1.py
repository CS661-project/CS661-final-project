...
layout = html.Div([
    ...
    html.Div(
        [
            html.Div([dcc.Graph(id="world_gdp",figure=fig),dcc.Graph(id="top10_gdp")],style={"display":"flex","flexDirection":"column"}),
            html.Div([dcc.Graph(id="factor_vs_year"),dcc.Graph(id="top10_factor")],style={"display":"flex","flexDirection":"column"})
        ]
        ,style={"display":"flex"}
    ) 
