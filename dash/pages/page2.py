...
)  # will have to add option to change trendline and options for it 
def generate_factor_vs_gdp(year_dropdown_pg2,factor_pg2,yaxis_type,xaxis_type):
    ...
    fig = px.scatter(df_final, x=year_dropdown_pg2+'_x', y=year_dropdown_pg2+'_y',hover_name='Country Name',trendline='lowess',trendline_options=dict(frac=0.3))
